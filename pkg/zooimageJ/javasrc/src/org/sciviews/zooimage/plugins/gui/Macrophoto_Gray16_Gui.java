...
public class Macrophoto_Gray16_Gui extends ZooImagePluginGui {

	public Macrophoto_Gray16_Gui(ZooImagePlugin plugin) {
		super(plugin);
	}
	...
	public boolean zimOptionsDialog() {
		...
		gd.addStringField("Read from directory: ", zimdir );
		...
		plugin.getCalibration().setMethod( plugin.getMethods()[i1Index] );
		if (i1Index == 1) {
